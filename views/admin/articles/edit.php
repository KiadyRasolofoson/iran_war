...
<style>
    ...
    .img-preview { margin-top: 8px; max-width: 100%; border-radius: 6px; border: 1px solid #ddd; }
...
<div class="page-header">
    <h1 style="margin:0;">Modifier l'article #<?= $h($articleId) ?></h1>
    <div class="actions">
    ...
    <div class="editor-layout">
        ...
        <aside class="editor-sidebar" data-hook="media-sidebar">
            ...
            <div>
                ...
                <?php if ($currentImage !== ''): ?>
                    <div style="margin-bottom: 12px; background: #fff; padding: 8px; border-radius: 6px; border: 1px solid #eee;">
                        <img class="img-preview" src="/<?= $h($currentImage) ?>" alt="" style="display:block; margin:0 auto 8px auto;">
                        <label style="font-weight: 400; font-size:12px; display:flex; align-items:center; gap:6px; cursor:pointer; color:#d32f2f;">
                            <input type="checkbox" name="remove_image" value="1" style="width: auto;"> Supprimer l'image
                        </label>
                    </div>
                <?php endif; ?>
